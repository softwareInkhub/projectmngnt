        ...
        <div className="px-3 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between gap-2 md:gap-4">
            <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
              <div className="flex items-center gap-1 md:gap-2 px-2 md:px-4 py-2 rounded-xl bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold shadow-lg flex-shrink-0">
                <Bell className="text-white mr-1 md:w-5 md:h-5" size={16} />
                <span className="text-xs md:text-base whitespace-nowrap">Notifications</span>
                {analytics.unreadNotifications > 0 && (
                  <span className="ml-1 md:ml-2 px-1.5 md:px-2 py-0.5 md:py-1 bg-white/20 rounded-full text-xs font-bold">
            ...
            <div className="flex items-center gap-1 md:gap-2 flex-shrink-0">
              ...
              <button 
                className="group flex items-center gap-1 md:gap-2 px-2 md:px-4 py-1.5 md:py-2 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-lg md:rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 font-semibold focus-ring text-xs md:text-sm whitespace-nowrap"
                onClick={clearAllNotifications}
              >
                <Trash2 size={14} className="md:w-5 md:h-5 group-hover:rotate-12 transition-transform duration-200" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 animate-fade-in">
                <div className="group bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-6 shadow-lg hover:shadow-xl border border-white/20 transition-all duration-300 hover:scale-105">
                  <div className="flex items-center justify-between mb-3 md:mb-4">
                    <div className="p-2 md:p-3 rounded-xl bg-gradient-to-br from-orange-500 to-red-600 text-white shadow-lg">
                      <Bell className="w-4 h-4 md:w-6 md:h-6" />
                    </div>
                    <TrendingUp className="w-4 h-4 md:w-5 md:h-5 text-emerald-500" />
                  </div>
                  <h3 className="text-xl md:text-3xl font-bold text-slate-900 mb-1">{analytics.totalNotifications}</h3>
                ...
                <div className="group bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-6 shadow-lg hover:shadow-xl border border-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <h3 className="text-xl md:text-3xl font-bold text-slate-900 mb-1">{analytics.unreadNotifications}</h3>
                ...
                <div className="group bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-6 shadow-lg hover:shadow-xl border border-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <h3 className="text-xl md:text-3xl font-bold text-slate-900 mb-1">{analytics.highPriorityNotifications}</h3>
                ...
                <div className="group bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-6 shadow-lg hover:shadow-xl border border-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <h3 className="text-xl md:text-3xl font-bold text-slate-900 mb-1">{analytics.todayNotifications}</h3>
                  <p className="text-slate-600 text-xs md:text-sm font-medium">Today</p>
                  <div className="mt-2 text-xs text-slate-500">Recent activity</div>
                </div>
              </div>

              {/* Enhanced Search and Filters */}
              <div className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border border-white/20 animate-fade-in" style={{ animationDelay: '200ms' }}>
                <div className="flex flex-col lg:flex-row gap-3 md:gap-4">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 md:py-3 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white/50 backdrop-blur-sm text-sm md:text-base"
                    />
                  </div>
                  
                  <div className="flex items-center gap-2 md:gap-3">
                    <button 
                      className="group flex items-center gap-2 px-3 md:px-4 py-2 md:py-3 border border-white/20 rounded-xl hover:bg-white/50 transition-all duration-200 hover:scale-105 focus-ring text-xs md:text-sm"
                  ...
                  <div className="mt-4 pt-4 border-t border-white/20 animate-fade-in">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3 md:gap-4">
                      <select
                        ...
                        className="px-3 py-2 border border-white/20 rounded-lg bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-orange-500 text-sm"
                      >
                      ...
                      <select className="px-3 py-2 border border-white/20 rounded-lg bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-orange-500 text-sm">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 text-slate-600 hover:text-slate-800 transition-colors text-sm"
                      >
                        <FilterX size={16} />
                        Clear All
                      </button>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
                {categories.map((category) => (
                  <button
                    ...
                    className={`group p-3 md:p-4 rounded-xl text-left transition-all duration-200 hover:scale-105 ${
                  ...
                  >
                    <div className="flex items-center gap-2 md:gap-3 mb-2">
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-slate-900 text-sm md:text-base">{category.label}</div>
            ...
            <div className="space-y-4 md:space-y-6">
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex items-start gap-3 md:gap-4">
                          <div className="flex items-center gap-2 md:gap-3">
                            <div className={`p-2 md:p-3 rounded-xl ${notificationTypes[notification.type as keyof typeof notificationTypes].bg} ${notificationTypes[notification.type as keyof typeof notificationTypes].color} shadow-lg`}>
                              <TypeIcon className="w-4 h-4 md:w-5 md:h-5" />
                            </div>
                            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-slate-500 to-gray-600 rounded-full flex items-center justify-center text-white font-bold text-xs md:text-sm">
                              {notification.avatar}
                            </div>
                          </div>
                          <div className="flex-1">
                            <div className="flex items-center gap-2 md:gap-3 mb-2">
                              <h4 className="text-base md:text-lg font-bold text-slate-900 group-hover:text-orange-600 transition-colors">
                                {notification.title}
                              </h4>
                            ...
                            <p className="text-xs md:text-sm text-slate-600 mb-2 md:mb-3">{notification.message}</p>
                            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 text-xs text-slate-500">
              ...
              {filteredNotifications.length === 0 && (
                <div className="text-center py-8 md:py-12 animate-fade-in">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 rounded-full bg-slate-100 flex items-center justify-center">
                  ...
                  <p className="text-slate-600 mb-4 text-sm">Try adjusting your search or filters</p>
                  <button 
