...
interface ZohoStyleDashboardProps {
  open: boolean;
  onClose: () => void;
  onOpenTab: (tabName: string, context?: any) => void;
}

const ZohoStyleDashboard: React.FC<ZohoStyleDashboardProps> = ({ open, onClose, onOpenTab }) => {
...
export default ZohoStyleDashboard;
